...
namespace Notifications.API.Extensions
{
    public static class ServiceExtension
    {
        ...
        private static IServiceCollection AddSharedInfrastructure(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.Configure<EmailSetting>(config.GetSection(nameof(EmailSetting))); 
            services.Configure<SmsSetting>(config.GetSection(nameof(SmsSetting)));
            services.Configure<ApplicationSetting>(config.GetSection(nameof(ApplicationSetting)));
